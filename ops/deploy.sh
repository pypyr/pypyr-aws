...
bumpversion --commit --tag ${BUMPLEVEL} 'pypyraws/version.py'

NEW_VERSION=`python -c 'import pypyraws.version; print(pypyraws.version.__version__)'`
...
# Deploy wheel
twine upload -s dist/pypyr_aws-${NEW_VERSION}-py3-none-any.whl
